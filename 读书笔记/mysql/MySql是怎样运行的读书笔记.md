...
1. m_ids:在生成ReadView时，当前系统中活跃的**读写事务的事务id列表**

2. min_trx_id:在生成ReadView时，当前系统中活跃的读写事务的事务id列表中**最小的值**

3. max_trx_id:在生成ReadView时，系统应该分配给**下一个事务的事务id**

   比如现在有1，2，3这三个事务，3提交了，那么min_trx_id就是1，max_trx_id就是4

4. creator_trx_id:生成readview的事务的事务id
